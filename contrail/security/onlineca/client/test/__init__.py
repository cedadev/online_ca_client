...
GET_CERT_SHELL_SCRIPT_PATH = os.path.join(
    CLIENT_SHELL_SCRIPTS_DIR, GET_CERT_SHELL_SCRIPT
)
GET_TRUSTROOTS_SHELL_SCRIPT_PATH = os.path.join(
    CLIENT_SHELL_SCRIPTS_DIR, GET_TRUSTROOTS_SHELL_SCRIPT
)
